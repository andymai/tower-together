...
/**
 * Flat daily income per anchor tile — used until entity checkout AI is
 * implemented (Phase 4). These are rough proxies for what a fully-occupied
 * room earns per day at the standard variant.
 */
